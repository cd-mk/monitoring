...
$(function () {
  ...
  var compose = $('.compose-email'),
    ...
    emailUserList = $('.monitor-list'),
    emailUserListInput = $('.monitor-list .custom-checkbox'),
  ...
  if (emailUserList.find('.monitor-box .card-body').length) {
    emailUserList.find('.monitor-box .card-body').on('click', function (e) {
